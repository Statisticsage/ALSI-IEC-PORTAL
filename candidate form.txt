...
function Section({ title, subtitle, children }: {
  ...
  return (
    <section className={cn('rounded-2xl', 'border', 'border-slate-200', 'bg-white', 'p-6', 'shadow-sm')}>
      <div className={cn('mb-6', 'border-b', 'border-slate-100', 'pb-4')}>
        <h3 className={cn('text-lg', 'font-bold', 'text-[#0B1F3A]')}>{title}</h3>
        {subtitle && <p className={cn('mt-1', 'text-sm', 'text-slate-500')}>{subtitle}</p>}
      </div>
      {children}
    </section>
  );
...
function Field({ label, required, className, children }: {
  ...
  return (
    <div className={className}>
      <label className={cn('mb-2', 'block', 'text-sm', 'font-medium', 'text-slate-700')}>
...
export default function CandidateRegistrationForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className={cn('grid', 'gap-8')}>
      ...
      <Section title="Electoral Details" subtitle="Select the position you are contesting.">
        ...
        <div className={cn('mt-6', 'grid', 'gap-4', 'md:grid-cols-2')}>
          <div className={cn('rounded-2xl', 'border', 'border-slate-200', 'bg-slate-50', 'p-5')}>
            <p className={cn('text-xs', 'font-semibold', 'uppercase', 'tracking-widest', 'text-slate-500')}>Registration Fee</p>
            <p className={cn('mt-2', 'text-3xl', 'font-bold', 'text-[#0B1F3A]')}>INR {fee.toLocaleString()}</p>
            <p className={cn('mt-1', 'text-xs', 'text-slate-500')}>Non-refundable. Pay before submitting.</p>
          </div>
          <div className={`rounded-2xl border p-5 ${gpaOk ? "border-green-200 bg-green-50" : "border-red-200 bg-red-50"}`}>
            <p className={cn('text-xs', 'font-semibold', 'uppercase', 'tracking-widest', 'text-slate-500')}>GPA Requirement</p>
          ...
          <div className={cn('grid', 'gap-4')}>
            ...
            <div>
              ...
              <input
                ...
                className={inp}
              />
              <p className={cn('mt-1.5', 'text-xs', 'text-slate-500')}>
      ...
      <div className={cn('rounded-2xl', 'border', 'border-amber-200', 'bg-amber-50', 'p-6')}>
        <p className={cn('text-sm', 'leading-7', 'text-amber-900')}>
      ...
      <div className={cn('flex', 'justify-end')}>
        <button type="submit" disabled={submitting}
          className={cn('rounded-xl', 'bg-[#0B1F3A]', 'px-10', 'py-4', 'text-sm', 'font-semibold', 'text-white', 'transition', 'hover:bg-[#153E75]', 'disabled:cursor-not-allowed', 'disabled:opacity-60')}>
